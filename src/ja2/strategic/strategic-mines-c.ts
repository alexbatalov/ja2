...
export function HasHisMineBeenProducingForPlayerForSomeTime(ubMinerProfileId: UINT8): boolean {
  let ubMineIndex: UINT8;
...
export function GetIdOfMineForSector(sSectorX: INT16, sSectorY: INT16, bSectorZ: INT8): INT8 {
