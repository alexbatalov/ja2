...
export const INSURANCE_TEXT_SINGLE_FILE = "BINARYDATA\\InsuranceSingle.edt";
export const INSURANCE_TEXT_MULTI_FILE = "BINARYDATA\\InsuranceMulti.edt";

const INSURANCE_TEXT_SINGLE = 1;
const INSURANCE_TEXT_MULTI = 2;

// Single line
export const enum Enum90 {
