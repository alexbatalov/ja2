const INSURANCE_TEXT_SINGLE_LINE_SIZE = 80 * 2;

const INSURANCE_TEXT_MULTI_LINE_SIZE = 5 * 80 * 2;

const INSURANCE_TEXT_SINGLE_FILE = "BINARYDATA\\InsuranceSingle.edt";
const INSURANCE_TEXT_MULTI_FILE = "BINARYDATA\\InsuranceMulti.edt";

const INSURANCE_TEXT_SINGLE = 1;
const INSURANCE_TEXT_MULTI = 2;
