...
const FIRST_MERCS_TEAMMODE_BUTTON = MERCS_PLAYER;
const LAST_MERCS_TEAMMODE_BUTTON = MERCS_CIVILIANTOGGLE;

const FIRST_MERCS_BASICMODE_BUTTON = MERCS_1;
const LAST_MERCS_BASICMODE_BUTTON = MERCS_DETAILEDCHECKBOX;

const FIRST_MERCS_PRIORITYMODE_BUTTON = MERCS_GENERAL;
const LAST_MERCS_PRIORITYMODE_BUTTON = MERCS_SCHEDULE;

const FIRST_MERCS_GENERAL_BUTTON = MERCS_PRIORITYEXISTANCE_CHECKBOX;
const LAST_MERCS_GENERAL_BUTTON = LAST_MERCS_COLORCODE_BUTTON;
const FIRST_MERCS_ORDERS_BUTTON = MERCS_ORDERS_STATIONARY;
const LAST_MERCS_ORDERS_BUTTON = MERCS_ORDERS_RNDPTPATROL;
const FIRST_MERCS_ATTITUDE_BUTTON = MERCS_ATTITUDE_DEFENSIVE;
const LAST_MERCS_ATTITUDE_BUTTON = MERCS_ATTITUDE_AGGRESSIVE;
const FIRST_MERCS_DIRECTION_BUTTON = MERCS_DIRECTION_N;
const LAST_MERCS_DIRECTION_BUTTON = MERCS_DIRECTION_FIND;
const FIRST_MERCS_REL_EQUIPMENT_BUTTON = MERCS_EQUIPMENT_BAD;
const LAST_MERCS_REL_EQUIPMENT_BUTTON = MERCS_EQUIPMENT_GREAT;
const FIRST_MERCS_REL_ATTRIBUTE_BUTTON = MERCS_ATTRIBUTES_BAD;
const LAST_MERCS_REL_ATTRIBUTE_BUTTON = MERCS_ATTRIBUTES_GREAT;
const FIRST_MERCS_COLORCODE_BUTTON = MERCS_ARMY_CODE;
const LAST_MERCS_COLORCODE_BUTTON = MERCS_ELITE_CODE;

const FIRST_MERCS_COLORMODE_BUTTON = MERCS_TOGGLECOLOR_BUTTON;
const LAST_MERCS_COLORMODE_BUTTON = MERCS_BODYTYPE_UP;
const FIRST_MERCS_COLOR_BUTTON = MERCS_HAIRCOLOR_DOWN;
const LAST_MERCS_COLOR_BUTTON = MERCS_PANTCOLOR_UP;
const FIRST_MERCS_BODYTYPE_BUTTON = MERCS_BODYTYPE_DOWN;
const LAST_MERCS_BODYTYPE_BUTTON = MERCS_BODYTYPE_UP;

const FIRST_MERCS_INVENTORY_BUTTON = MERCS_HEAD_SLOT;
const LAST_MERCS_INVENTORY_BUTTON = MERCS_PACK4_SLOT;

const FIRST_MERCS_GETITEM_BUTTON = FIRST_ITEMS_BUTTON;
const LAST_MERCS_GETITEM_BUTTON = LAST_ITEMS_BUTTON;

const FIRST_MERCS_SCHEDULE_BUTTON = MERCS_SCHEDULE_ACTION1;
const LAST_MERCS_SCHEDULE_BUTTON = MERCS_SCHEDULE_CLEAR;
