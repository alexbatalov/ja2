...
export const FIRST_MERCS_TEAMMODE_BUTTON = Enum32.MERCS_PLAYER;
export const LAST_MERCS_TEAMMODE_BUTTON = Enum32.MERCS_CIVILIANTOGGLE;

export const FIRST_MERCS_BASICMODE_BUTTON = Enum32.MERCS_1;
export const LAST_MERCS_BASICMODE_BUTTON = Enum32.MERCS_DETAILEDCHECKBOX;

export const FIRST_MERCS_PRIORITYMODE_BUTTON = Enum32.MERCS_GENERAL;
export const LAST_MERCS_PRIORITYMODE_BUTTON = Enum32.MERCS_SCHEDULE;

export const FIRST_MERCS_GENERAL_BUTTON = Enum32.MERCS_PRIORITYEXISTANCE_CHECKBOX;
export const LAST_MERCS_GENERAL_BUTTON = LAST_MERCS_COLORCODE_BUTTON;
export const FIRST_MERCS_ORDERS_BUTTON = Enum32.MERCS_ORDERS_STATIONARY;
export const LAST_MERCS_ORDERS_BUTTON = Enum32.MERCS_ORDERS_RNDPTPATROL;
export const FIRST_MERCS_ATTITUDE_BUTTON = Enum32.MERCS_ATTITUDE_DEFENSIVE;
export const LAST_MERCS_ATTITUDE_BUTTON = Enum32.MERCS_ATTITUDE_AGGRESSIVE;
export const FIRST_MERCS_DIRECTION_BUTTON = Enum32.MERCS_DIRECTION_N;
export const LAST_MERCS_DIRECTION_BUTTON = Enum32.MERCS_DIRECTION_FIND;
export const FIRST_MERCS_REL_EQUIPMENT_BUTTON = Enum32.MERCS_EQUIPMENT_BAD;
export const LAST_MERCS_REL_EQUIPMENT_BUTTON = Enum32.MERCS_EQUIPMENT_GREAT;
export const FIRST_MERCS_REL_ATTRIBUTE_BUTTON = Enum32.MERCS_ATTRIBUTES_BAD;
export const LAST_MERCS_REL_ATTRIBUTE_BUTTON = Enum32.MERCS_ATTRIBUTES_GREAT;
export const FIRST_MERCS_COLORCODE_BUTTON = Enum32.MERCS_ARMY_CODE;
export const LAST_MERCS_COLORCODE_BUTTON = Enum32.MERCS_ELITE_CODE;

export const FIRST_MERCS_COLORMODE_BUTTON = Enum32.MERCS_TOGGLECOLOR_BUTTON;
export const LAST_MERCS_COLORMODE_BUTTON = Enum32.MERCS_BODYTYPE_UP;
export const FIRST_MERCS_COLOR_BUTTON = Enum32.MERCS_HAIRCOLOR_DOWN;
export const LAST_MERCS_COLOR_BUTTON = Enum32.MERCS_PANTCOLOR_UP;
export const FIRST_MERCS_BODYTYPE_BUTTON = Enum32.MERCS_BODYTYPE_DOWN;
export const LAST_MERCS_BODYTYPE_BUTTON = Enum32.MERCS_BODYTYPE_UP;

export const FIRST_MERCS_INVENTORY_BUTTON = Enum32.MERCS_HEAD_SLOT;
export const LAST_MERCS_INVENTORY_BUTTON = Enum32.MERCS_PACK4_SLOT;

export const FIRST_MERCS_GETITEM_BUTTON = Enum32.FIRST_ITEMS_BUTTON;
export const LAST_MERCS_GETITEM_BUTTON = Enum32.LAST_ITEMS_BUTTON;
