...
#define SINGLEROOF_NUMELEMENTS ((LASTROOF - FIRSTROOF + 1) + (LASTSLANTROOF - FIRSTSLANTROOF + 1) + (LASTWALL - FIRSTWALL + 1) + (SECONDONROOF - FIRSTONROOF + 1))
...
#define ROOM_NUMELEMENTS ((LASTWALL - FIRSTWALL + 1) + (LASTFLOOR - FIRSTFLOOR + 1) + (LASTROOF - FIRSTROOF + 1) + (2))
