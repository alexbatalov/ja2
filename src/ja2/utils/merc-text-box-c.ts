...
// the list of boxes
let gpPopUpBoxList: (MercPopUpBox | null)[] /* Pointer<MercPopUpBox>[MAX_NUMBER_OF_POPUP_BOXES] */ = createArray(MAX_NUMBER_OF_POPUP_BOXES, null);
...
export function RenderMercPopUpBoxFromIndex(iBoxId: INT32, sDestX: INT16, sDestY: INT16, uiBuffer: UINT32): boolean {
  // set the current box
...
export function RenderMercPopupBox(sDestX: INT16, sDestY: INT16, uiBuffer: UINT32): boolean {
...
export function PrepareMercPopupBox(iBoxId: INT32, ubBackgroundIndex: UINT8, ubBorderIndex: UINT8, pString: string /* STR16 */, usWidth: UINT16, usMarginX: UINT16, usMarginTopY: UINT16, usMarginBottomY: UINT16, pActualWidth: Pointer<UINT16>, pActualHeight: Pointer<UINT16>): INT32 {
  ...
  ({ ubFontColor, ubFontShadowColor} = GetMercPopupBoxFontColor(ubBackgroundIndex));
...
function GetMercPopupBoxFontColor(ubBackgroundIndex: UINT8): { ubFontColor: UINT8, ubFontShadowColor: UINT8 } {
  let ubFontColor: UINT8;
  let ubFontShadowColor: UINT8;
