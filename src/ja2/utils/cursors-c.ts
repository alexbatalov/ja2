...
let CursorFileDatabase: CursorFileData[] /* [] */ = [
  ...
  createCursorFileDataFrom("CURSORS\\cur_targ.sti", false, 0, ANIMATED_CURSOR, 7),
  createCursorFileDataFrom("CURSORS\\cur_tagr.sti", false, 0, ANIMATED_CURSOR, 7),
  createCursorFileDataFrom("CURSORS\\targblak.sti", false, 0, ANIMATED_CURSOR, 7),
  createCursorFileDataFrom("CURSORS\\cur_bst.sti", false, 0, ANIMATED_CURSOR, 7),
  createCursorFileDataFrom("CURSORS\\cur_rbst.sti", false, 0, ANIMATED_CURSOR, 7),
  createCursorFileDataFrom("CURSORS\\burstblk.sti", false, 0, ANIMATED_CURSOR, 7),
  createCursorFileDataFrom("CURSORS\\cur_tr.sti", false, 0, 0, 0),
  createCursorFileDataFrom("CURSORS\\cur_trw.sti", false, 0, 0, 0),
  createCursorFileDataFrom("CURSORS\\cur_tb.sti", false, 0, ANIMATED_CURSOR, 7),

  createCursorFileDataFrom("CURSORS\\punch.sti", false, 0, ANIMATED_CURSOR, 6),
  createCursorFileDataFrom("CURSORS\\punchr.sti", false, 0, ANIMATED_CURSOR, 6),
  createCursorFileDataFrom("CURSORS\\cur_run.sti", false, 0, ANIMATED_CURSOR, 10),
  createCursorFileDataFrom("CURSORS\\cur_walk.sti", false, 0, ANIMATED_CURSOR, 10),
  createCursorFileDataFrom("CURSORS\\cur_swat.sti", false, 0, ANIMATED_CURSOR, 10),
  createCursorFileDataFrom("CURSORS\\cur_pron.sti", false, 0, ANIMATED_CURSOR, 10),
  ...
  createCursorFileDataFrom("CURSORS\\stabr.sti", false, 0, ANIMATED_CURSOR, 6),

  createCursorFileDataFrom("CURSORS\\cross1.sti", false, 0, ANIMATED_CURSOR, 6),
  createCursorFileDataFrom("CURSORS\\cross2.sti", false, 0, ANIMATED_CURSOR, 6),
  ...
  createCursorFileDataFrom("", false, 0, USE_EXTERN_VO_CURSOR | USE_OUTLINE_BLITTER, 0),
