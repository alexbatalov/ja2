...
const DEFAULT_EXTERN_PANEL_X_POS = 320;
const DEFAULT_EXTERN_PANEL_Y_POS = 40;

const DIALOGUE_TACTICAL_UI = 1;
const DIALOGUE_CONTACTPAGE_UI = 2;
const DIALOGUE_NPC_UI = 3;
const DIALOGUE_SPECK_CONTACT_PAGE_UI = 4;
const DIALOGUE_EXTERNAL_NPC_UI = 5;
const DIALOGUE_SHOPKEEPER_UI = 6;

const DIALOGUE_SPECIAL_EVENT_GIVE_ITEM = 0x00000001;
const DIALOGUE_SPECIAL_EVENT_TRIGGER_NPC = 0x00000002;
const DIALOGUE_SPECIAL_EVENT_GOTO_GRIDNO = 0x00000004;
const DIALOGUE_SPECIAL_EVENT_DO_ACTION = 0x00000008;
const DIALOGUE_SPECIAL_EVENT_CLOSE_PANEL = 0x00000010;
const DIALOGUE_SPECIAL_EVENT_PCTRIGGERNPC = 0x00000020;
const DIALOGUE_SPECIAL_EVENT_BEGINPREBATTLEINTERFACE = 0x00000040;
const DIALOGUE_SPECIAL_EVENT_SKYRIDERMAPSCREENEVENT = 0x00000080;
const DIALOGUE_SPECIAL_EVENT_SHOW_CONTRACT_MENU = 0x00000100;
const DIALOGUE_SPECIAL_EVENT_MINESECTOREVENT = 0x00000200;
const DIALOGUE_SPECIAL_EVENT_SHOW_UPDATE_MENU = 0x00000400;
const DIALOGUE_SPECIAL_EVENT_ENABLE_AI = 0x00000800;
const DIALOGUE_SPECIAL_EVENT_USE_ALTERNATE_FILES = 0x00001000;
const DIALOGUE_SPECIAL_EVENT_CONTINUE_TRAINING_MILITIA = 0x00002000;
const DIALOGUE_SPECIAL_EVENT_CONTRACT_ENDING = 0x00004000;
const DIALOGUE_SPECIAL_EVENT_MULTIPURPOSE = 0x00008000;
const DIALOGUE_SPECIAL_EVENT_SLEEP = 0x00010000;
const DIALOGUE_SPECIAL_EVENT_DO_BATTLE_SND = 0x00020000;
const DIALOGUE_SPECIAL_EVENT_SIGNAL_ITEM_LOCATOR_START = 0x00040000;
const DIALOGUE_SPECIAL_EVENT_SHOPKEEPER = 0x00080000;
const DIALOGUE_SPECIAL_EVENT_SKIP_A_FRAME = 0x00100000;
const DIALOGUE_SPECIAL_EVENT_EXIT_MAP_SCREEN = 0x00200000;
const DIALOGUE_SPECIAL_EVENT_DISPLAY_STAT_CHANGE = 0x00400000;
const DIALOGUE_SPECIAL_EVENT_UNSET_ARRIVES_FLAG = 0x00800000;
const DIALOGUE_SPECIAL_EVENT_TRIGGERPREBATTLEINTERFACE = 0x01000000;
const DIALOGUE_ADD_EVENT_FOR_SOLDIER_UPDATE_BOX = 0x02000000;
const DIALOGUE_SPECIAL_EVENT_ENTER_MAPSCREEN = 0x04000000;
const DIALOGUE_SPECIAL_EVENT_LOCK_INTERFACE = 0x08000000;
const DIALOGUE_SPECIAL_EVENT_REMOVE_EPC = 0x10000000;
const DIALOGUE_SPECIAL_EVENT_CONTRACT_WANTS_TO_RENEW = 0x20000000;
const DIALOGUE_SPECIAL_EVENT_CONTRACT_NOGO_TO_RENEW = 0x40000000;
const DIALOGUE_SPECIAL_EVENT_CONTRACT_ENDING_NO_ASK_EQUIP = 0x80000000;

const MULTIPURPOSE_SPECIAL_EVENT_DONE_KILLING_DEIDRANNA = 0x00000001;
const MULTIPURPOSE_SPECIAL_EVENT_TEAM_MEMBERS_DONE_TALKING = 0x00000002;
