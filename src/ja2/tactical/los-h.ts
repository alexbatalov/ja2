...
const STANDING_HEIGHT = 191.0;
const STANDING_LOS_POS = 175.0;
const STANDING_FIRING_POS = 175.0;
const STANDING_HEAD_TARGET_POS = 175.0;
const STANDING_HEAD_BOTTOM_POS = 159.0;
const STANDING_TORSO_TARGET_POS = 127.0;
const STANDING_TORSO_BOTTOM_POS = 95.0;
const STANDING_LEGS_TARGET_POS = 47.0;
const STANDING_TARGET_POS = STANDING_HEAD_TARGET_POS;

const CROUCHED_HEIGHT = 130.0;
const CROUCHED_LOS_POS = 111.0;
const CROUCHED_FIRING_POS = 111.0;

const CROUCHED_HEAD_TARGET_POS = 111.0;
const CROUCHED_HEAD_BOTTOM_POS = 95.0;
const CROUCHED_TORSO_TARGET_POS = 71.0;
const CROUCHED_TORSO_BOTTOM_POS = 47.0;
const CROUCHED_LEGS_TARGET_POS = 31.0;
const CROUCHED_TARGET_POS = CROUCHED_HEAD_TARGET_POS;

const PRONE_HEIGHT = 63.0;
const PRONE_LOS_POS = 31.0;
const PRONE_FIRING_POS = 31.0;
const PRONE_TORSO_TARGET_POS = 31.0;
const PRONE_HEAD_TARGET_POS = 31.0;
const PRONE_LEGS_TARGET_POS = 31.0;
