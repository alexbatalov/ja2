...
export const FINDSOLDIERSAMELEVEL = (l: number) => (((FIND_SOLDIER_FULL | FIND_SOLDIER_SAMELEVEL) | (l << 16)));

export const FINDSOLDIERSELECTIVESAMELEVEL = (l: number) => (((FIND_SOLDIER_SELECTIVE | FIND_SOLDIER_SAMELEVEL) | (l << 16)));
