...
function BuildDayLightLevels(): void {
  ...
  */
  ...
  for (uiLoop = 0; uiLoop < 9; uiLoop++) {
    AddEveryDayStrategicEvent(Enum132.EVENT_CHANGELIGHTVAL, DAWN_START + 2 * uiLoop, NORMAL_LIGHTLEVEL_NIGHT - 1 - uiLoop);
  }

  // Add events for hot times
  AddEveryDayStrategicEvent(Enum132.EVENT_TEMPERATURE_UPDATE, DESERT_WARM_START, Enum303.TEMPERATURE_DESERT_WARM);
  AddEveryDayStrategicEvent(Enum132.EVENT_TEMPERATURE_UPDATE, DESERT_HOT_START, Enum303.TEMPERATURE_DESERT_HOT);
  AddEveryDayStrategicEvent(Enum132.EVENT_TEMPERATURE_UPDATE, DESERT_HOT_END, Enum303.TEMPERATURE_DESERT_WARM);
  AddEveryDayStrategicEvent(Enum132.EVENT_TEMPERATURE_UPDATE, DESERT_WARM_END, Enum303.TEMPERATURE_DESERT_COOL);

  AddEveryDayStrategicEvent(Enum132.EVENT_TEMPERATURE_UPDATE, GLOBAL_WARM_START, Enum303.TEMPERATURE_GLOBAL_WARM);
  AddEveryDayStrategicEvent(Enum132.EVENT_TEMPERATURE_UPDATE, GLOBAL_HOT_START, Enum303.TEMPERATURE_GLOBAL_HOT);
  AddEveryDayStrategicEvent(Enum132.EVENT_TEMPERATURE_UPDATE, GLOBAL_HOT_END, Enum303.TEMPERATURE_GLOBAL_WARM);
  AddEveryDayStrategicEvent(Enum132.EVENT_TEMPERATURE_UPDATE, GLOBAL_WARM_END, Enum303.TEMPERATURE_GLOBAL_COOL);
  ...
  */
  ...
  for (uiLoop = 0; uiLoop < 9; uiLoop++) {
    AddEveryDayStrategicEvent(Enum132.EVENT_CHANGELIGHTVAL, DUSK_START + 2 * uiLoop, NORMAL_LIGHTLEVEL_DAY + 1 + uiLoop);
  }
...
function BuildDayAmbientSounds(): void {
  ...
  for (cnt = 0; cnt < gsNumAmbData; cnt++) {
    switch (gAmbData[cnt].ubTimeCatagory) {
      case AMB_TOD_DAWN:
        AddSameDayRangedStrategicEvent(Enum132.EVENT_AMBIENT, DAWN_START, DAWN_TO_DAY, cnt);
        break;
      case AMB_TOD_DAY:
        AddSameDayRangedStrategicEvent(Enum132.EVENT_AMBIENT, DAY_START, DAY_TO_DUSK, cnt);
        break;
      case AMB_TOD_DUSK:
        AddSameDayRangedStrategicEvent(Enum132.EVENT_AMBIENT, DUSK_START, DUSK_TO_NIGHT, cnt);
        break;
      case AMB_TOD_NIGHT:
        AddSameDayRangedStrategicEvent(Enum132.EVENT_AMBIENT, NIGHT_START, NIGHT_TO_DAWN, cnt);
        break;
    }
  }
